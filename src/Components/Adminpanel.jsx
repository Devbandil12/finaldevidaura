...
import { FaTachometerAlt, FaBox, FaTicketAlt, FaClipboardList, FaUsers, FaEnvelope } from 'react-icons/fa';
          ...
          {activeTab === "dashboard" && (
            <div className="space-y-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <OrderChart delivered={deliveredOrders} pending={processingOrders} cancelled={cancelledOrders} />
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {orders.filter((o) => {
                  ...
                  if (orderStatusTab === "Cancelled") return o.status === "Order Cancelled";
                  return o.status === orderStatusTab;
                }).filter((o) => o.id.toString().includes(orderSearchQuery.trim())).map((order) => (
