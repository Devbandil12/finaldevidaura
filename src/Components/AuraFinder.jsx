...
import { Sparkles, X, ArrowRight, Loader2, RefreshCcw } from "lucide-react";
...
export default function AuraFinder() {
  ...
  const [step, setStep] = useState(0); // 0: Closed, 1: Q1, 2: Q2, 3: Loading, 4: Result
  ...
  const findMatchOnServer = async (occasion, vibe) => {
    try {
      ...
      // Artificial delay for "Thinking" effect (Luxury Feel)
      setTimeout(() => {
